package test.uk.co.dubit.collections
{
	...
	import uk.co.dubit.collections.HashMapObservable;

	public class HashMapObservableTest extends TestCase implements IMapObserver
	{
		private var map:HashMapObservable;
		...
		{
			this.map = new HashMapObservable();

package test.uk.co.dubit.gameEngine.script.behaviors
{
	...
	import uk.co.dubit.gameEngine.script.behaviors.TestGameObjectAttribute;
	
	public class TestGameObjectAttributeTest extends AbstractBehaviorTestCase
	{
		public function TestGameObjectAttributeTest(testMethod:String=null)
		{
			super(testMethod);
			
			this.engine.getGameObjectFactory().createGameObject(GameObjectConstants.TYPE_BASIC, "testAtts");
			this.gameObject = this.engine.getGameObjectManager().getGameObject("testAtts");
			this.gameObject.setAttribute("TEST_NUMBER", 100);
		}
		
		private var behavior:TestGameObjectAttribute;
		private var gameObject :IGameObject;
		
		override protected function setUp():void
		{
			this.behavior = new TestGameObjectAttribute(this.engine);
			this.behavior.setAttribute(BehaviorConstants.GAME_OBJECT_ID,"testAtts");

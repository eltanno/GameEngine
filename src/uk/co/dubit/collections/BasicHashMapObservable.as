package uk.co.dubit.collections
{
	...
	public class BasicHashMapObservable extends BasicHashMap implements IBasicMapObservable
	{
		public function BasicHashMapObservable()
		{
		...
		private static var logger:Logger = Logger.getLogger(getQualifiedClassName(BasicHashMapObservable));

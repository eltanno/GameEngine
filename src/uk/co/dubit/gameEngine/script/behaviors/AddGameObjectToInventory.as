package uk.co.dubit.gameEngine.script.behaviors
{
	...
	public class AddGameObjectToInventory extends BasicBehavior
	{
		public function AddGameObjectToInventory(engine:Engine, parent:AbstractScriptNode=null, delay:int=0)
		{
